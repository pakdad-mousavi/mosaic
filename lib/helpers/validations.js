...
export const validateSquareOptions = (sharedOptions, squareOptions) => {
  // Extract params
  const { fitMode, imageSize, paddingColor, columns, caption, captionColor } = squareOptions;
...
export const validateAspectOptions = (sharedOptions, squareOptions) => {
  // Extract params
  const { aspectRatio, imageWidth, columns, caption, captionColor } = squareOptions;
