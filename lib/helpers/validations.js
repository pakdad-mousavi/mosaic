import { displayWarningMessage, isSupportedOutputImage, isValidHexadecimal, parseAspectRatio, SUPPORTED_INPUT_FORMATS } from './utils.js';
...
export const validateSharedOptions = (sharedOptions) => {
  ...
  if (!isSupportedOutputImage(output)) {
    throw new Error('Invalid output format. Choose one of the following: ' + SUPPORTED_INPUT_FORMATS.join(', '));
  }
