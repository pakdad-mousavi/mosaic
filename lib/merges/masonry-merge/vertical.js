...
export const buildVerticalMasonry = async (images, params) => {
  const { gap, canvasColor, arc, canvasHeight, columnWidth, vAlign } = params;
  ...
  return await createMasonryLayout(columns, columnWidth, canvasWidth, canvasHeight, canvasColor, arc, gap, vAlign);
};

const createMasonryLayout = async (cols, columnWidth, canvasWidth, canvasHeight, canvasColor, arc, gap, vAlign) => {
  const composites = [];
