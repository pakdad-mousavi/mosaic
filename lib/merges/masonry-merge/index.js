...
import { calculateAvgColumns, calculateAvgColumnWidth, calculateAvgRowHeight, calculateAvgRows } from './utils.js';
...
const computeDynamicDefault = (key, images) => {
  switch (key) {
    case 'rows':
      return calculateAvgRows(images);
    case 'rowHeight':
      return calculateAvgRowHeight(images);
    case 'columns':
      return calculateAvgColumns(images);
    case 'columnWidth':
