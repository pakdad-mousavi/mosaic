...
export const buildHorizontalMasonry = async (images, params) => {
  const { gap, canvasColor, arc, canvasWidth, rowHeight, hAlign } = params;
  ...
  return await createMasonryLayout(rows, rowHeight, canvasWidth, canvasHeight, canvasColor, arc, gap, hAlign);
};

const createMasonryLayout = async (rows, rowHeight, canvasWidth, canvasHeight, canvasColor, arc, gap, hAlign) => {
  const canvas = sharp({
